...
pp1=ggplot(aes(x=gene_annotation, y=-log10(p1), colour=group), data=Data)+geom_point()+theme_pub()+geom_hline(yintercept=5.4, colour="black")+theme(axis.title.x = element_blank(), axis.title.y = element_blank())+ theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1, size=5))+theme(plot.title = element_text(hjust = 0))+ggtitle("A")
```
...
pp2=ggplot(aes(x=gene_annotation, y=-log10(p2), colour=group), data=Data)+geom_point()+theme_pub()+geom_hline(yintercept=5.4, colour="black")+theme(axis.title.x = element_blank(), axis.title.y = element_blank())+ theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1, size=5))+theme(plot.title = element_text(hjust = 0))+ggtitle("B")
```
